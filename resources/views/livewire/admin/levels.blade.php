                ...
                <tbody class="divide-y divide-gray-800">
                    @forelse($levels as $level)
                        <tr class="transition duration-150 hover:bg-gray-800">
                            ...
                            <td class="px-6 py-4 font-medium text-gray-200">{{ $level->name }}</td>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-70">
            <div class="w-full max-w-lg bg-gray-900 border border-gray-800 shadow-2xl rounded-xl">
                ...
                <div class="p-6 border-b border-gray-800">
                    ...
                    <p class="mt-1 text-sm text-gray-400">Gérez les informations du niveau</p>
                </div>

                <!-- Modal Body -->
                <form wire:submit.prevent="saveLevel" class="p-6 space-y-5">
                    <div>
                        <label class="block mb-2 text-sm font-semibold text-gray-300">Nom du niveau</label>
                        <input type="text" wire:model.defer="name" placeholder="Entrez le nom du niveau"
